...
public class VentanaBuscarEliminarSede extends JFrame{
	...
	public VentanaBuscarEliminarSede(String accion) {
...
//		add(action);
		...
		Image temp;
		temp = new ImageIcon("src/Imagenes/BorrarSede.png").getImage();
		ImageIcon img;
		img = new ImageIcon(
