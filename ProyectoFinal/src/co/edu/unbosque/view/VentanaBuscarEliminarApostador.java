...
public class VentanaBuscarEliminarApostador extends JFrame{
	private JButton ingresar, regresar;
	private JTextField cedula;
	private JLabel imagenFondo, action;

	public VentanaBuscarEliminarApostador(String accion) {
...
//		add(action);
		...
		Image temp;
		temp = new ImageIcon("src/Imagenes/BorrarApostador.png").getImage();
		ImageIcon img;
		img = new ImageIcon(
		...
		ingresar.setToolTipText("Editar Apostador");
		add(ingresar);
	}
