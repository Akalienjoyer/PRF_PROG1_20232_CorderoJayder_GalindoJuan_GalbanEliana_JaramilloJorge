...
public class VentanaFacturarChance extends JFrame {

	private JTextField cedula, valor, num1, num2, num3, num4, nombreLoteria;
	...
	public VentanaFacturarChance() {
		...
		nombreLoteria.setBounds(630, 274, 300, 50);
		...
		nombreLoteria.setToolTipText("Ingresa el Numero #5 a Jugar");
		add(nombreLoteria);

		imagenFondo = new JLabel();
		imagenFondo.setBounds(0, 0, getWidth(), getHeight());
		Image temp;
		temp = new ImageIcon("src/Imagenes/FacturarChance.png").getImage();
		ImageIcon img;
		img = new ImageIcon(
