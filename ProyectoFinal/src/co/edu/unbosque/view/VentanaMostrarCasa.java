...
public class VentanaMostrarCasa extends JFrame{

	private JButton regresar;
	private JLabel imagenFondo, nombre, presupuesto, cantSedes;
	
	public VentanaMostrarCasa() {
		...
		nombre = new JLabel();
		nombre.setText("Null");
		nombre.setBounds(210, 268, 500, 50);
		...
		presupuesto.setBounds(345, 415, 500, 50);
		...
		cantSedes.setBounds(345, 555, 500, 50);
		...
		Image temp;
		temp = new ImageIcon("src/Imagenes/InfoCasa.png").getImage();
		ImageIcon img;
		img = new ImageIcon(
