...
public class VentanaCreacionApostador extends JFrame{
	...
	public VentanaCreacionApostador (String accion) {
...
//		add(tipo);
		...
		Image temp;
		temp = new ImageIcon("src/Imagenes/CrearApostador.png").getImage();
		ImageIcon img;
		img = new ImageIcon(
