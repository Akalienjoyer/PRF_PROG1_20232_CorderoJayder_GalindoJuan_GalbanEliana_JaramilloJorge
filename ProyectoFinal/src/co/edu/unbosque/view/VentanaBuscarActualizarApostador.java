...
public class VentanaBuscarActualizarApostador extends JFrame{
	private JButton ingresar, regresar;
	private JTextField cedula;
	private JLabel imagenFondo, action;

	public VentanaBuscarActualizarApostador(String accion) {
...
//		add(action);
		...
		Image temp;
		temp = new ImageIcon("src/Imagenes/EditarApostador.png").getImage();
		ImageIcon img;
		img = new ImageIcon(
		...
		ingresar.setToolTipText("Eliminar Apostador");
		add(ingresar);
	}
